...
function LandingPage() {
  return (
    <main className="page-wrap px-4 pb-20 pt-14">
      ...
      <section className="island-shell rise-in relative overflow-hidden rounded-[2rem] px-6 py-12 sm:px-10 sm:py-20">
        ...
        <div className="relative z-10">
          ...
          <p className="mb-10 max-w-2xl text-lg leading-relaxed text-[var(--sea-ink-soft)] sm:text-xl">
            Bugfixes isn't just another logging tool. It's a specialized pipeline
            that transforms crashes into normalized, deduplicated, and
      ...
      <section className="mt-24 grid gap-8 sm:grid-cols-2">
        <div className="flex flex-col justify-center pr-4">
          ...
          <p className="mb-6 text-lg text-[var(--sea-ink-soft)] leading-relaxed">
            Stop trawling through logs looking for why it broke.
            Bugfixes lets your errors do the ticket creation, so you can focus
            on the fix. We treat every crash as the primary source of truth for
      ...
      {/* CTA Section */}
      <section id="setup" className="mt-24 rounded-[2rem] bg-emerald-950 px-8 py-16 text-center text-white">
